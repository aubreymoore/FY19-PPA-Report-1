...
\maketitle
\begin{description}	
	\item[Report ID:] AP18PPQFO000C402-PE-SA1-20
	\item[Report Type:] Performance Report
	\item[Reporting Period:]  SA1-20
	\item[Performance Period:] October 10, 2019 through March 10, 2020
\end{description}

\begin{footnotesize}
\url{https://github.com/aubreymoore/FY19-PPA-Report-1/raw/master/PPA18-report-4.pdf}
\end{footnotesize}
